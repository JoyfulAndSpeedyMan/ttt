package com.bolingx.seller.mvc;
...
import com.bolingx.seller.mvc.interceptor.UserTokenVerifyInterceptor;
import com.bolingx.seller.mvc.resolver.UserArgumentResolver;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public RequestValidationFilter requestValidationFilter(ServerProperties serverProperties,
        ...
        config.getIgnorePathSet().add("/user/hello");
